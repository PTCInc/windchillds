...
public final class ConnectionFactoryProvider {
    ...
    private static final String TLS_PROTOCOL_VERSION= System.getProperty("TLS_PROTOCOL_VERSION", "TLSv1.2") ;
            ...
            try {
                if (useSSLArg.isPresent() || useStartTLSArg.isPresent()) {
                    ...
                    if (sslContext == null) {
                        ...
                        sslContext =
                                new SSLContextBuilder().setProtocol(TLS_PROTOCOL_VERSION).setTrustManager(trustManager)
